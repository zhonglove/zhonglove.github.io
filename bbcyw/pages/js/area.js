...
function change(v){
	...
	Gid('BombBox_show').value = Gid('s_province').value + "," + Gid('s_city').value + "," + Gid('s_county').value;
}
...
dsy.add("0_23_0",["观山湖区","乌当区","南明区","云岩区","花溪区","白云区","小河区","清镇市","开阳县","修文县","息烽县"]);
...
var opt0 = ["请选择省份","请选择城市","请选择区县"];//初始值
